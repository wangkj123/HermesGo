HermesGo green portable package (v0.14, three UIs)
HermesGo 绿色便携包（v0.14，三套界面）

Current release tag: v0.14.0-green-3ui-slim
当前发行标签：v0.14.0-green-3ui-slim
...
v0.14 includes Kanban backend for WebUI.
v0.14 含 WebUI 看板后端。
