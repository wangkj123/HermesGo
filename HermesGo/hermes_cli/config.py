...
OPTIONAL_ENV_VARS = {
    ...
    "KILOCODE_API_KEY": {
        "description": "Kilo Code API key (Kilo Gateway). Used to access Kilo's routed/free models when available.",
        "prompt": "Kilo Code API key",
    ...
    "KILOCODE_BASE_URL": {
        "description": "Kilo Code base URL override (leave empty for default)",
        "prompt": "Kilo Code base URL (leave empty for default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
