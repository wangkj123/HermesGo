...
def list_authenticated_providers(
    ...
    for pid, overlay in HERMES_OVERLAYS.items():
        ...
        # Fallback: check the credential pool after auth-store seeding.
        # This catches credentials already persisted by HermesGo but not yet
        # mirrored into the in-memory status we built above.
        if not has_creds:
            try:
