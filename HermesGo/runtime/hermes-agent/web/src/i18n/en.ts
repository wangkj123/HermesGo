...
export const en: Translations = {
  ...
  oauth: {
    ...
    description: "{connected} of {total} OAuth providers connected. Open the dashboard to start a login flow, or copy the launch command when you want a one-step shortcut.",
    connected: "Connected",
    expired: "Expired",
    notConnected: "Not connected. Use {command} to start login.",
    runInTerminal: "to start login.",
    ...
    copied: "Copied ✓",
    cli: "Command",
    copyCliCommand: "Copy launch command (for external / fallback)",
    connect: "Connect",
    sessionExpires: "Session expires in {time}",
    initiatingLogin: "Initiating login flow…",
    exchangingCode: "Exchanging code for tokens…",
    browserLoginStarted: "HermesGo started an isolated OpenAI browser login in the background.",
    browserLoginHint: "This login is stored only inside the current HermesGo directory and does not touch your existing Codex login.",
    browserSwitchHint: "HermesGo cleared only its own local Codex session. Finish the browser login to switch HermesGo to another OpenAI account.",
