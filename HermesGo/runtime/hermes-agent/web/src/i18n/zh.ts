...
export const zh: Translations = {
  ...
  oauth: {
    ...
    description: "已连接 {connected}/{total} 个 OAuth 提供商。推荐先打开 dashboard 启动登录，也可以复制启动命令走一步到位的方式。",
    connected: "已连接",
    expired: "已过期",
    notConnected: "未连接。使用 {command} 开始登录。",
    runInTerminal: "开始登录。",
    ...
    copied: "已复制 ✓",
    cli: "命令",
    copyCliCommand: "复制启动命令（用于外部/备用方式）",
    connect: "连接",
    sessionExpires: "会话将在 {time} 后过期",
    initiatingLogin: "正在启动登录流程…",
    exchangingCode: "正在交换令牌…",
    browserLoginStarted: "HermesGo 已在后台启动隔离的 OpenAI 网页登录。",
    browserLoginHint: "本次登录只会保存在当前 HermesGo 目录，不会影响你正在使用的 Codex 登录。",
    browserSwitchHint: "HermesGo 只清除了自己的本地 Codex 会话。完成网页登录后，就会切到另一个 OpenAI 账号。",
